...
const IconHome = ({ active }) => (
  <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
    <path d="M3 10.5L12 3l9 7.5V20a1 1 0 01-1 1H15v-5h-6v5H4a1 1 0 01-1-1V10.5z"
      ...
      strokeLinecap="round" strokeLinejoin="round" fill={active ? '#E0F5F2' : 'none'} />
  </svg>
)
const IconInventory = ({ active }) => (
  <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
    <rect x="3" y="3" width="18" height="18" rx="3"
      stroke={active ? '#1A9E8F' : '#9CA3AF'} strokeWidth="1.75" fill={active ? '#E0F5F2' : 'none'} />
...
const IconRecord = ({ active }) => (
  <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
    <circle cx="12" cy="12" r="9"
      stroke={active ? '#1A9E8F' : '#9CA3AF'} strokeWidth="1.75" fill={active ? '#1A9E8F' : 'none'} />
    <path d="M12 8v4l2.5 2.5" stroke={active ? '#fff' : '#9CA3AF'} strokeWidth="1.75" strokeLinecap="round" />
  </svg>
)
...
const IconSettings = ({ active }) => (
  <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
    <circle cx="12" cy="12" r="3" stroke={active ? '#1A9E8F' : '#9CA3AF'} strokeWidth="1.75" />
...
const HIDE_NAV = ['/', '/signin', '/signup', '/business-type', '/quiz', '/connect-etsy', '/import']
        ...
        return (
          <button key={path} onClick={() => navigate(path)}
            ...
            <span className="text-[10px] font-medium"
              style={{ color: active ? '#0F6E56' : '#9CA3AF' }}>{label}</span>
          </button>
        )
      })}
    </nav>
