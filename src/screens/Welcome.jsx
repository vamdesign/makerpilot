...
const EtsyIllustration = () => (
  <svg width="100%" viewBox="0 0 360 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <polygon points="36,139 39,143 36,141 33,143" fill="#0F6E56" opacity="0.6" />
    ...
    {/* ══ 2. HOME DECOR — vase with flowers ══ */}
    <path d="M118 162 Q108 150 112 132 Q116 118 130 118 Q144 118 148 132 Q152 150 142 162Z"
      fill="#E0F5F2" stroke="#1A9E8F" strokeWidth="1.5" />
    ...
    <path d="M116 140 Q130 136 144 140" stroke="#1A9E8F" strokeWidth="1" opacity="0.4" fill="none" />
    <path d="M114 148 Q130 144 146 148" stroke="#1A9E8F" strokeWidth="1" opacity="0.3" fill="none" />
    ...
    <circle cx="140" cy="85" r="2.5" fill="white" opacity="0.7" />

    {/* ══ 3. CRAFT SUPPLIES — cup with brushes + pencils ══ */}
    ...
    <circle cx="288" cy="120" r="2" fill="white" opacity="0.5" />
    <circle cx="303" cy="125" r="2.5" fill="white" opacity="0.6" />

    {/* Stars / confetti */}
    <path d="M322 112 L324 117 L329 117 L325 120 L327 125 L322 122 L317 125 L319 120 L315 117 L320 117Z"
      fill="#EF9F27" opacity="0.8" />
    <path d="M266 105 L268 110 L273 110 L269 113 L271 118 L266 115 L261 118 L263 113 L259 110 L264 110Z"
      fill="#1A9E8F" opacity="0.7" />
    ...
    <path d="M325 140 Q323 133 327 135 Q329 137 329 140" fill="#0F6E56" opacity="0.7" />
    <path d="M333 140 Q335 133 331 135 Q329 137 329 140" fill="#0F6E56" opacity="0.7" />
    <circle cx="329" cy="140" r="2.5" fill="#1A9E8F" />

    {/* ── Low stock badge floating above vase ── */}
    ...
    <circle cx="355" cy="120" r="3" fill="#9FE1CB" opacity="0.5" />
    <circle cx="15" cy="130" r="3" fill="#9FE1CB" opacity="0.5" />
  </svg>
)
...
const Feature = ({ icon, title, desc }) => (
  <div className="flex items-start gap-3 py-3 border-b border-gray-50 last:border-0">
    <div className="w-9 h-9 rounded-xl bg-teal-light flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-teal flex items-center justify-center">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <path d="M12 2L22 12L12 17L2 12L12 2Z" fill="white" opacity="0.9" />
              <path d="M12 17V22" stroke="white" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
          <span className="font-serif text-xl text-teal-dark italic">MakerPilot</span>
        </div>
        <button
